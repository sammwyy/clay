...
complete -c clay -f -n '__fish_use_subcommand' -a skill -d 'Manage skills without starting the agent'
...
complete -c clay -n '__fish_seen_subcommand_from skill' -a 'install remove enable disable' -d 'Skill command'
